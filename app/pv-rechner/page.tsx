          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-20 max-h-[calc(100vh-6rem)] overflow-y-auto">
              ...
              <div className="pt-6 border-t border-[var(--color--medium-grey)]">
                ...
                {showSettings && (
                  <div className="mt-3 p-3 bg-[var(--color--light-grey)] rounded-lg">
                    <Link
                      href="/admin"
                      className="flex items-center gap-2 text-sm text-[var(--color--light-blue)] font-semibold hover:underline"
                    >
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
