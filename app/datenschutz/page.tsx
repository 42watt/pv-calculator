    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'var(--w-surface)' }}>
      ...
      <main className="flex-1">
        <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
          <h1 className="text-3xl md:text-4xl font-bold text-[var(--color--black)] mb-8">Datenschutzhinweis</h1>
          ...
          <div className="legal-content">
            ...
            <p>
              ...
              Infanteriestr. 11<br />
              80797 München<br />
              Mail: <a href="mailto:kundenservice@42watt.de">kundenservice@42watt.de</a><br />
              Telefon: +49 (0) 89 2152509 0
            </p>
            ...
            <p>
              ...
              widerrufen. Sie können sich jederzeit mit einer Beschwerde an eine Aufsichtsbehörde wenden, z. B. an die
            ...
            <p>
              ...
              Dies ist für die Daten, die der Bereitstellung der Webseite dienen, grundsätzlich der Fall, wenn die
            ...
            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Wie viele andere Webseiten verwenden wir auch so genannte &bdquo;Cookies&rdquo;. Bei Cookies handelt es sich um
            ...
            <p>
              ...
              Betriebssystem. Cookies können nicht verwendet werden, um Programme zu starten oder Viren auf einen
            ...
            <p>
              ...
              Verwendung von Cookies jederzeit über die Einstellungen Ihres Browsers deaktivieren.
            </p>

            <h3>Speicherdauer und eingesetzte Cookies</h3>
            <p>
              Soweit Sie uns durch Ihre Browsereinstellungen oder Zustimmung die Verwendung von Cookies erlauben,
              können folgende Cookies auf unseren Webseiten zum Einsatz kommen. Sie können über Ihre
              Browsereinstellungen einzelne Cookies oder den gesamten Cookie-Bestand löschen.
            </p>

            <h2>4) Registrierung auf unserer Website</h2>
            ...
            <p>
              ...
              Einwilligung des Nutzers (Art. 6 Abs. 1 lit. a DSGVO). Dient die Registrierung der Erfüllung eines
              Vertrages, dessen Vertragspartei die betroffene Person ist oder der Durchführung vorvertraglicher
              Maßnahmen, so ist zusätzliche Rechtsgrundlage für die Verarbeitung der Daten Art. 6 Abs. 1 lit. b
              DSGVO.
            </p>
            ...
            <p>
              ...
              auf unsere angebotenen Inhalte und Leistungen gewähren.
            </p>

            <h2>5) Erbringung kostenpflichtiger Leistungen</h2>

            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Zur Erbringung kostenpflichtiger Leistungen werden von uns zusätzliche Daten erfragt, wie z.B.
              Zahlungsangaben, um Ihre Bestellung ausführen zu können.
            </p>
            ...
            <h3>Speicherdauer</h3>
            <p>
              Wir speichern diese Daten in unseren Systemen bis die gesetzlichen Aufbewahrungsfristen abgelaufen
              sind. Diese betragen grundsätzlich 6 oder 10 Jahre aus Gründen der ordnungsmäßigen Buchführung und
            ...
            <p>
              ...
              personenbezogenen Daten können wir Ihnen keinen Zugang auf unsere angebotenen Inhalte und
              Leistungen gewähren.
            </p>
            ...
            <p>
              ...
              zuzustellen. Die Angabe Ihres Namens erfolgt, um Sie im Newsletter persönlich ansprechen zu können
              und ggf. zu identifizieren, falls Sie von Ihren Rechten als Betroffener Gebrauch machen wollen.
            </p>
            <p>
              Für den Empfang des Newsletters ist die Angabe Ihrer E-Mail-Adresse ausreichend. Bei der Anmeldung
              zum Bezug unseres Newsletters werden die von Ihnen angegebenen Daten ausschließlich für diesen
              Zweck verwendet. Wir setzen das &bdquo;Double-opt-in&rdquo;-Verfahren ein. Weitere Daten werden nicht erhoben.
              Die Daten werden ausschließlich für den Newsletterversand verwendet und nicht an Dritte
              weitergegeben.
            </p>
            ...
            <p>
              ...
              wir Ihnen regelmäßig unseren Newsletter bzw. vergleichbare Informationen per E-Mail an Ihre
              angegebene E-Mail-Adresse. Die Einwilligung zur Speicherung Ihrer persönlichen Daten und ihrer
              Nutzung für den Newsletterversand können Sie jederzeit mit Wirkung für die Zukunft widerrufen.
            </p>
            ...
            <p>
              ...
              berechtigten Interesses (Art. 6 Abs. 1 lit. f DSGVO). Sofern Sie mit uns Kontakt aufnehmen, um ein
              Angebot zu erfragen, erfolgt die Verarbeitung der Daten zur Durchführung vorvertraglicher Maßnahmen
              (Art. 6 Abs. 1 lit. b DSGVO).
            </p>
            ...
            <p>
              ...
              Vertragsverhältnis kommt, unterliegen wir den gesetzlichen Aufbewahrungsfristen nach HGB und löschen
            ...
            <p>
              ...
              nur bearbeiten, sofern Sie uns Ihren Namen, Ihre E-Mail-Adresse und den Grund der Anfrage mitteilen.
            </p>

            <h2>8) Verwendung von Google Analytics</h2>

            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Diese Website benutzt Google Analytics, einen Webanalysedienst der Google LLC, 1600 Amphitheatre
              Parkway, Mountain View, CA 94043 USA (nachfolgend: &bdquo;Google&rdquo;). Google Analytics verwendet sog.
              &bdquo;Cookies&rdquo;, also Textdateien, die auf Ihrem Computer gespeichert werden und die eine Analyse der
              Benutzung der Webseite durch Sie ermöglichen. Die durch das Cookie erzeugten Informationen über
            ...
            <h3>Rechtsgrundlage</h3>
            <p>
              Die Verarbeitung der Daten erfolgt auf Grundlage einer Einwilligung des Nutzers (Art. 6 Abs. 1
              lit. a DSGVO).
            </p>
            ...
            <p>
              ...
              Nutzung der Webseite bezogenen Daten an Google sowie die Verarbeitung dieser Daten durch Google
            ...
            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Um unsere Inhalte browserübergreifend korrekt und grafisch ansprechend darzustellen, verwenden wir
              auf dieser Website &bdquo;Google Web Fonts&rdquo; der Google LLC (1600 Amphitheatre Parkway, Mountain View,
              CA 94043, USA; nachfolgend &bdquo;Google&rdquo;) zur Darstellung von Schriften.
            </p>

            <h3>Rechtsgrundlage</h3>
            <p>
              Rechtsgrundlage für die Einbindung von Google Webfonts und dem damit verbundenen Datentransfer zu
              Google ist Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
            </p>

            <h3>Speicherdauer</h3>
            <p>
              Wir erheben keine personenbezogenen Daten durch die Einbindung von Google Webfonts. Weitere
            ...
            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Auf dieser Webseite nutzen wir das Angebot von Google Maps. Google Maps wird von Google LLC, 1600
              Amphitheatre Parkway, Mountain View, CA 94043, USA (nachfolgend &bdquo;Google&rdquo;) betrieben. Dadurch können
              wir Ihnen interaktive Karten direkt in der Webseite anzeigen und ermöglichen Ihnen die komfortable
            ...
            <h2>11) Eingebettete YouTube-Videos</h2>

            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Auf einigen unserer Webseiten betten wir YouTube-Videos ein. Betreiber der entsprechenden Plugins
              ist die YouTube, LLC, 901 Cherry Ave., San Bruno, CA 94066, USA (nachfolgend &bdquo;YouTube&rdquo;). Wenn Sie
              eine Seite mit dem YouTube-Plugin besuchen, wird eine Verbindung zu Servern von YouTube hergestellt.
            ...
            <h2>12) Social Plugins</h2>
            <p>
              Auf unseren Webseiten werden Social Plugins der unten aufgeführten Anbieter eingesetzt. Die Plugins
              können Sie daran erkennen, dass sie mit dem entsprechenden Logo gekennzeichnet sind. Wir verhindern
              die unbewusste und ungewollte Erfassung und Übertragung von Daten an den Diensteanbieter durch eine
              2-Klick-Lösung.
            </p>
            ...
            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Unsere Webseite nutzt das Google Conversion-Tracking. Betreibergesellschaft der Dienste von Google
              AdWords ist die Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Sind Sie über
              eine von Google geschaltete Anzeige auf unsere Webseite gelangt, wird von Google AdWords ein Cookie
              auf Ihrem Rechner gesetzt.
            </p>

            <h3>Rechtsgrundlage</h3>
            <p>
              Rechtsgrundlage für die Einbindung von Google AdWords und dem damit verbundenen Datentransfer zu
              Google ist Ihre Einwilligung (Art. 6 Abs. 1 lit. a DSGVO).
            </p>
            ...
            <h2>14) Facebook Pixel</h2>
            <p>
              Innerhalb unseres Onlineangebotes wird das sog. &bdquo;Facebook-Pixel&rdquo; des sozialen Netzwerkes Facebook
              eingesetzt, welches von der Facebook Inc., 1 Hacker Way, Menlo Park, CA 94025, USA, bzw. falls Sie
              in der EU ansässig sind, Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2,
              Irland betrieben wird.
            </p>
            <p>
              Mithilfe des Facebook-Pixels ist es Facebook möglich, Sie als Besucher unseres Onlineangebotes als
              Zielgruppe für die Darstellung von Anzeigen (sog. &bdquo;Facebook-Ads&rdquo;) zu bestimmen.
            </p>

            <h3>Rechtsgrundlage</h3>
            <p>
              Der Einsatz des Facebook Pixel sowie die Speicherung von &bdquo;Conversion-Cookies&rdquo; erfolgt auf Grundlage
            ...
            <p>
              ...
              Facebook-Ads widersprechen. Um einzustellen, welche Arten von Werbeanzeigen Ihnen innerhalb von
              Facebook angezeigt werden, können Sie die von Facebook eingerichtete Seite aufrufen und dort die
              Hinweise zu den Einstellungen nutzungsbasierter Werbung befolgen.
            </p>

            <h2>15) Verwendung von Zoho SalesIQ und Zoho PageSense</h2>

            <h3>Art und Zweck der Verarbeitung</h3>
            <p>
              Beim Besuch unserer Webseite werden anonymisierte Nutzungsdaten mittels dem ZOHO Dienst SalesIQ
              erhoben. SalesIQ verwendet Cookies, welche die Analyse der Webseitenbesuche zu Zwecken des Marketing
              ermöglichen. Sie können durch entsprechende Einstellungen in Ihrem Browser diese Analyse für Ihren
              Besuch unserer Webseite verhindern.
            </p>
            <p>
              Über den Dienst SalesIQ stellen wir zudem eine Chatfunktion in unserem Webauftritt bereit. Sie
              können den Chat vollständig anonym bedienen. Optional können Sie Ihren Namen und Ihre E-Mail-Adresse
              in die Chat-Kontaktfelder eingeben.
            </p>
            <p>
              Beim Besuch unserer Webseite werden anonymisierte Nutzungsdaten mittels dem ZOHO Dienst PageSense
              erhoben. PageSense zeichnet lediglich den Besuch und Klicks auf unserer Webseite vollkommen anonym
              auf. Es gibt keinen Rückschluss auf einzelne Besucher.
            </p>
            ...
            <p>
              <em>
                ...
                Datenschutzbeauftragte (Version #2019-04-10).
              </em>
            </p>
          </div>
        </div>
